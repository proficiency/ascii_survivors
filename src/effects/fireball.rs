        ...
        for fireball in fireball_query.iter() {
                ...
                && draw_position.y < terminal_size[1] as i32
            {
                ...
                fireball_char.decoration.fg_color =
                    Some(bevy::prelude::LinearRgba::from(Color::linear_rgb(r, g, b)));

                terminal.put_string(
                    [draw_position.x as usize, draw_position.y as usize],
                    fireball_char,
                );
                ...
                if fireball.size > 1 {
                    ...
                    for (offset, char) in &particles {
                            ...
                            && particle_pos.y < terminal_size[1] as i32
                        {
                            ...
                            let g = intensity * 0.3;
                            let b = 0.0;
                            particle_char.decoration.fg_color =
                                Some(bevy::prelude::LinearRgba::from(Color::linear_rgb(r, g, b)));
                            terminal.put_string(
                                [particle_pos.x as usize, particle_pos.y as usize],
                                particle_char,
                            );
                        }
                    }
